...
class Controller extends Component implements ViewContextInterface
{
    ...
    public function beforeAction($action)
    {
        ...
        if (Yii::$app->controller->id == 'visiteur') {
            if (in_array(Yii::$app->controller->action->id, Yii::$app->params['visiteur'])) {
                $this->layout = '@app/views/layouts/visiteur.php';
            }
        }
    ...
    public function afterAction($action, $result)
    {
        ...
        if (md5(Yii::$app->controller->action->id) == 'deconnecter') {
