    ...
    <div class="modal-dialog modal-dialog-centered mw-650px" data-select2-id="select2-data-130-0luo">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="exampleModalLabel">Modification Publicité</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form id="PubliciteUpdate" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                ...
                <div class="modal-body">
                        ...
                        <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                            ...
                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                ...
                                <a href="javascript:;" Class="btn " data-bs-toggle="modal"
                                    data-bs-target="#vuePrincipalePubModal">
                    ...
                    <div class="fv-row mb-12">
                        <label class="col-sm-4 form-label"> <?= Yii::t('app', 'titrePub') ?> : <span class="asterisk">*</span>
                        </label>
                        <div class="fv-row mb-12">
                            <input type="text" value="" class="form-control" name="titleField"
                                id="titleField" autocomplete="off" />
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-12 form-label"> <?= Yii::t('app', 'content') ?> :
                        </label>
                        <div class="col-sm-12">
                            <textarea rows="3" type="text" class="form-control" name="contentField"
                                id="contentField" autocomplete="off"></textarea>
                        </div>
                    </div>
			...
			<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15 mt-15">
				...
				<p>
					<input type="button" value="<?= yii::t("app", "validecrop") ?>" id="image-getterupdate"
						...
						data-bs-target="#vuePrincipalePubModal" class="btn btn-primary">
				</p>
				<a href="javascript:;" Class="btn btn-light me-3" id="retour" data-bs-toggle="modal"
					data-bs-target="#vuePrincipalePubModal"></a>
			</div>
		</div>
	</div>
</div>
