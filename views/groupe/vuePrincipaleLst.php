                    ...
                    <div class="card-header  bg-primary border-0 pt-2">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base" >
                                ...
                                <!--begin::Add user-->
								<div class="card-toolbar">
								<a href="<?= yii::$app->request->baseUrl . '/' . md5('etsconfig_addtypeusers') ?>"
...
<?php require_once('contenu/addtype.php') ?>
<?php require_once('contenu/update.php') ?>
<?php require_once('contenu/script/script.php') ?>