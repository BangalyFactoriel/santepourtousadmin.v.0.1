	...
	//  die(var_dump($data['code']));
        ...
        echo '
            <tr>
                ...
                <td>' .$etat. '</td>
				<td>
                <a href="javascript:;" Class="btn btn-circle btn-primary " onClick="$(\'#action_key\').val(\'' . md5('utilisateur_adduser') . '\');$(\'#nomUpdate\').val(\''.$data["nom"].'\'); $(\'#prenomUpdate\').val(\'' . ($data["prenom"]) . '\');$(\'#typeusersupdate\').val(\'' .$libtype . '\'); $(\'#statutCatUpdate\').val(\'' . $data["statut"] . '\'); $(\'.action_on_this\').val(\''.$data["code"].'\'); $(\'#kt_modal_edit_user_scroll\').modal(\'show\');"><i class="fa fa-indent"></i>&nbsp;' . Yii::t("app", "edit") . '</a>
                </td>
